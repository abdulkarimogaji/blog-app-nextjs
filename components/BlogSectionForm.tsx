    ...
    <section className="bg-white p-8 border border-gray-300 rounded-lg my-8">
      ...
      <div className="my-12">
        ...
        <input
          ...
          name={`sectionTitle${secNum}`}
          className="border hover:border-gray-600 focus:border-gray-600 container rounded-lg p-2 pe-5 text-lg outline-none"
        />
      </div>
      <div className="my-12">
        <p className="md:text-lg text-base font-semibold md:mb-8 mb-4">
