  ...
  if (isSuccess) {
    return (
      <div className="md:w-2/3 w-4/5 flex flex-col justify-center navbar-offset my-center md:pt-16 pt-32  pb-16 gap-4">
        {
          filterTag &&
        <h1 className='text-xl font-semibold'>Blogs for tag "{filterTag}": <button className='md:p-2 p-1 md:px-4 mr-4 px-2 text-xs md:text-sm action-btn rounded-lg' onClick={() => setFilterTag("")}>Clear</button></h1>
        }
        {
